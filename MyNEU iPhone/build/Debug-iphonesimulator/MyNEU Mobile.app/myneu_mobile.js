...
/*if(window.location.pathname.search("cps/welcome/loginok.html") != -1) {
...
function loadHandler(event) {
	...
	if(url.search("render.userLayoutRootNode.uP") != -1) {
		...
		urls = {
			...
			'Transactions': 'https://prod-web.neu.edu/webapp/ISF/cardTxns.do',
			'Mail': 'http://myneu.neu.edu/cp/ip/login?sys=google&url=http://mail.google.com/a/husky.neu.edu',
			'Blackboard': 'http://myneu.neu.edu/cp/ip/login?sys=bb&url=http://blackboard.neu.edu',
			//'Schedule': 'https://bnr8ssbp.neu.edu/udcprod8/bwskfshd.P_CrseSchdDetl',
			'Schedule': 'http://myneu.neu.edu/cp/ip/login?sys=sctssb&url=https://bnr8ssbp.neu.edu/udcprod8/bwskfshd.P_CrseSchdDetl',
			'Log Out': 'http://myneu.neu.edu/up/Logout'
		};
